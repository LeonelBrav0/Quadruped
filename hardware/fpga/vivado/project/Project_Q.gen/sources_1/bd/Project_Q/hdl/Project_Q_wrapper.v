...
module Project_Q_wrapper
  ...
  inout zynqmp_iic_scl_io;
  inout zynqmp_iic_sda_io;
  inout zynqmp_spi_io0_io;
  inout zynqmp_spi_io1_io;
  inout zynqmp_spi_sck_io;
  inout zynqmp_spi_ss_io;
  input zynqmp_uart_rxd;
  output zynqmp_uart_txd;
  ...
  wire zynqmp_iic_scl_i;
  wire zynqmp_iic_scl_io;
  wire zynqmp_iic_scl_o;
  wire zynqmp_iic_scl_t;
  wire zynqmp_iic_sda_i;
  wire zynqmp_iic_sda_io;
  wire zynqmp_iic_sda_o;
  wire zynqmp_iic_sda_t;
  wire zynqmp_spi_io0_i;
  wire zynqmp_spi_io0_io;
  wire zynqmp_spi_io0_o;
  wire zynqmp_spi_io0_t;
  wire zynqmp_spi_io1_i;
  wire zynqmp_spi_io1_io;
  wire zynqmp_spi_io1_o;
  wire zynqmp_spi_io1_t;
  wire zynqmp_spi_sck_i;
  wire zynqmp_spi_sck_io;
  wire zynqmp_spi_sck_o;
  wire zynqmp_spi_sck_t;
  wire zynqmp_spi_ss_i;
  wire zynqmp_spi_ss_io;
  wire zynqmp_spi_ss_o;
  wire zynqmp_spi_ss_t;
  wire zynqmp_uart_rxd;
  wire zynqmp_uart_txd;
  ...
  Project_Q Project_Q_i
       (.fan_en_b(fan_en_b),
        ...
        .zynqmp_iic_scl_i(zynqmp_iic_scl_i),
        .zynqmp_iic_scl_o(zynqmp_iic_scl_o),
        .zynqmp_iic_scl_t(zynqmp_iic_scl_t),
        .zynqmp_iic_sda_i(zynqmp_iic_sda_i),
        .zynqmp_iic_sda_o(zynqmp_iic_sda_o),
        .zynqmp_iic_sda_t(zynqmp_iic_sda_t),
        .zynqmp_spi_io0_i(zynqmp_spi_io0_i),
        .zynqmp_spi_io0_o(zynqmp_spi_io0_o),
        .zynqmp_spi_io0_t(zynqmp_spi_io0_t),
        .zynqmp_spi_io1_i(zynqmp_spi_io1_i),
        .zynqmp_spi_io1_o(zynqmp_spi_io1_o),
        .zynqmp_spi_io1_t(zynqmp_spi_io1_t),
        .zynqmp_spi_sck_i(zynqmp_spi_sck_i),
        .zynqmp_spi_sck_o(zynqmp_spi_sck_o),
        .zynqmp_spi_sck_t(zynqmp_spi_sck_t),
        .zynqmp_spi_ss_i(zynqmp_spi_ss_i),
        .zynqmp_spi_ss_o(zynqmp_spi_ss_o),
        .zynqmp_spi_ss_t(zynqmp_spi_ss_t),
        .zynqmp_uart_rxd(zynqmp_uart_rxd),
        .zynqmp_uart_txd(zynqmp_uart_txd));
  ...
  IOBUF rpi_gpio_tri_iobuf_9
       (.I(rpi_gpio_tri_o_9),
        ...
        .O(rpi_gpio_tri_i_9),
        .T(rpi_gpio_tri_t_9));
  IOBUF zynqmp_iic_scl_iobuf
       (.I(zynqmp_iic_scl_o),
        .IO(zynqmp_iic_scl_io),
        .O(zynqmp_iic_scl_i),
        .T(zynqmp_iic_scl_t));
  IOBUF zynqmp_iic_sda_iobuf
       (.I(zynqmp_iic_sda_o),
        .IO(zynqmp_iic_sda_io),
        .O(zynqmp_iic_sda_i),
        .T(zynqmp_iic_sda_t));
  IOBUF zynqmp_spi_io0_iobuf
       (.I(zynqmp_spi_io0_o),
        .IO(zynqmp_spi_io0_io),
        .O(zynqmp_spi_io0_i),
        .T(zynqmp_spi_io0_t));
  IOBUF zynqmp_spi_io1_iobuf
       (.I(zynqmp_spi_io1_o),
        .IO(zynqmp_spi_io1_io),
        .O(zynqmp_spi_io1_i),
        .T(zynqmp_spi_io1_t));
  IOBUF zynqmp_spi_sck_iobuf
       (.I(zynqmp_spi_sck_o),
        .IO(zynqmp_spi_sck_io),
        .O(zynqmp_spi_sck_i),
        .T(zynqmp_spi_sck_t));
  IOBUF zynqmp_spi_ss_iobuf
       (.I(zynqmp_spi_ss_o),
        .IO(zynqmp_spi_ss_io),
        .O(zynqmp_spi_ss_i),
        .T(zynqmp_spi_ss_t));
